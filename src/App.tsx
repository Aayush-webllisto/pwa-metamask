...
import {hashMessage, hashTypedDataMessage, sanitizeHex, verifySignature,} from './helpers/utilities';
...
class App extends React.Component<any, any> {
    ...
    public testSendTransaction = async () => {
        ...
        console.log('connector, address, chainId',{connector, address, chainId});
        ...
        console.log('testSendTransaction<---->tx',tx)
    ...
    public testSignTransaction = async () => {
        ...
        console.log('testSignTransaction<---->tx',tx)
        ...
        try {
            ...
            console.log('connector.signTransaction',connector.signTransaction)
                ...
                <Column maxWidth={1000} spanHeight>
                    ...
                    <SContent>
                        {!address && !assets.length ? (
                            <SLanding center>
                                <h3>{`MetaMask Connect PWA`}</h3>
                                <p>{`Progressive web application to connect your Application to metamask`}</p>
                                <SButtonContainer>
